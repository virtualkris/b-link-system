...
<div class="resident-profile-card">
    <section class="resident-profile-column">
        <h2>Household & Personal Information</h2>
    ...
    <section class="resident-profile-column">
        <h2>Contact, Background & Sector</h2>
    ...
    <section class="resident-profile-column">
        <h2>Health, Evaluation & Emergency Contact</h2>

        <p><strong>Medical Condition:</strong> <?= $resident['has_medical_condition'] ? 'Yes' : 'No' ?></p>
        <p><strong>Details:</strong> <?= htmlspecialchars($resident['medical_condition_details'] ?? 'N/A') ?></p>
        <p><strong>Needs Medicine:</strong> <?= $resident['needs_medicine'] ? 'Yes' : 'No' ?></p>
        <p><strong>Mobility Status:</strong> <?= htmlspecialchars(ucfirst($resident['mobility_status'] ?? 'normal')) ?></p>
        <p><strong>Evacuation Priority:</strong> <?= htmlspecialchars(ucfirst($resident['evacuation_priority'] ?? 'low')) ?></p>
